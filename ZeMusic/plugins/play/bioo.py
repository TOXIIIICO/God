...
@app.on_message(filters.command(["زخرفه","الزخارف","✨زخارف"], ""))
...
async def bioo2(c: Client, m: CallbackQuery):
    ...
    await m.message.delete()
    abrag_text = """    
    𓌹𝚂𝙾𝚄𝚁𝙲𝙴 𝙶𝙾𝙳𝚉𝙸𝙻𝙻𝙰𓌺(https://t.me/El_Godzy)\n
...
async def bnat1(c: Client, m: CallbackQuery):
    ...
    await m.message.delete()
    abrag_text = """
[●━◉⟞⟦ 𓌹𝚂𝙾𝚄𝚁𝙲𝙴 𝙶𝙾𝙳𝚉𝙸𝙻𝙻𝙰𓌺」ま ⟧⟝◉━●](https://t.me/El_Godzy)\n- 𝑎𝑠𝑜 𐇲.
                - 𝑎𝑛𝑜 𐇲.
                - 𝑡𝑏𝑜 𐇲.
                - 𝑡𝑛𝑜 𐇲.
                - 𝒛𝒉𝒐 𐇲.
