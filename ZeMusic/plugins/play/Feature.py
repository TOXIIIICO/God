...
@app.on_message(
    filters.command(["مميزات","مميزات جودزلا"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس جودزلا  ميوزك\n
𓌹𝚂𝙾𝚄𝚁𝙲𝙴 𝙶𝙾𝙳𝚉𝙸𝙻𝙻𝙰𓌺

★قايمه مميزات سورس جودزلا 
            ...
            [
                [
                    InlineKeyboardButton(
                        "#𓌹𝚂𝙾𝚄𝚁𝙲𝙴 𝙶𝙾𝙳𝚉𝙸𝙻𝙻𝙰𓌺⚡", url=f"https://t.me/El_Godzy"),                        
                 ],[
                InlineKeyboardButton(
